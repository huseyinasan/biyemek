...
import '../screens/customer_screens/authentication/non_login_product_detail_page.dart';
import '../services/customer_product_service.dart';
import 'category_products_item.dart';

class NonLoginProductGridView extends StatelessWidget {
  const NonLoginProductGridView({
    Key? key,
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => NonLoginProductDetailsPage(
